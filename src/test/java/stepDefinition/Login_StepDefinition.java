...
public class Login_StepDefinition {
	...
	public void user_is_in_ds_algo_home_page() {
	...
	public void the_user_clicks_login_button_after_entering_valid_username_as_and_valid_password_as()
			throws IOException {
		loginPage.login();
	...
	public void the_user_clicks_login_button_with_valid_credentials_from_sheet_with(String sheet, String testcase_id)
			throws IOException {
		loginPage.login();
	...
	@Given("User logged in to Dsalgo portal by using {string} and {string} user is on home page after login")
	public void user_logged_in_to_dsalgo_portal_by_using_and_user_is_on_home_page_after_login(String userName,
