...
Scenario Outline: User enters valid/invalid python code for practice questions and verifies the output of run
...
Scenario Outline: User enters valid/invalid python code for practice questions and verifies the output of Submit
Given The user is on the practice question editor for "<question_link>" 
When The user write the "<Testcase_ID>" python code in Editor from excel "<sheetName>"
And The user clicks submit button
Then Verify the success message "Submitted Successfully" is displayed for submit
