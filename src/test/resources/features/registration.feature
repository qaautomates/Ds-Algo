...
Scenario: Verify Registration functionality with invalid credential 
Given User clicked on " Register " link
And User is on registration  page
...
Scenario: Verify Registration functionality with valid credential 
Given User clicked on " Register " link
And User is on registration  page
When The user enters the username as "TestQA101", password as "September2025$" and password confirmation as "September2025$"
And User clicks Register button
Then User should be able to see the expected message "New Account Created. You are logged in as TestQA101"
