...
Given The user is on the "<link>" topic page in Data Structures Introduction
When The user clicks the Practice Questions link within the Data Structures Introduction module
Then The user should be redirected to the "Practice Questions" for Data Structures Introduction 
